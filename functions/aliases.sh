...
alias install-most='(build install-tools install-schwartz install-web install-web-test build-thrift-php-interface generate-payment-service-client && buildweb refresh-live-mission-control-data-from-production)'
# Install all geodata
