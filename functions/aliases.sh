...
alias install-most='(build install-tools install-web install-web-test generate-payment-service-client install-psyche install-themis && buildweb refresh-live-mission-control-data-from-production)'
# Install all geodata
